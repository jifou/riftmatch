...
const articles = [
  {
    ...
    content: [
      ...
      {
        type: 'h2',
        children: [{ text: "JDG survit par le lower bracket, BLG éliminé" }],
      },
      {
        type: 'p',
        children: [
      ...
      {
        type: 'h2',
        children: [{ text: 'Weibo Gaming également éliminé' }],
      },
      {
        type: 'p',
        children: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'h2',
        children: [{ text: 'JDG Fights Back, BLG Falls Short' }],
      },
      {
        type: 'p',
        children: [
      ...
      {
        type: 'h2',
        children: [{ text: 'Weibo Gaming Also Eliminated' }],
      },
      {
        type: 'p',
        children: [
          {
            text: "Weibo Gaming, another marquee LPL name, was also knocked out before the lower bracket final. Their elimination alongside BLG highlights just how competitive the China qualifier was this year, with no team safe regardless of regular season pedigree.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'h2',
        children: [{ text: 'JDG Remonta, BLG Queda Fuera' }],
      },
      {
        type: 'p',
        children: [
          {
            text: "Tras su derrota frente a AL, JDG tuvo que pelear a través del lower bracket. Superaron varios rivales hasta alcanzar la gran final del lower bracket contra Bilibili Gaming (BLG). En un intenso best-of-three el 22 de mayo, JDG se impuso 2-1 para asegurar el segundo cupo chino en el EWC 2026. BLG, uno de los equipos más regulares de la LPL esta temporada, se queda sin plaza en el evento principal.",
          },
        ],
      },
      {
        type: 'h2',
        children: [{ text: 'Weibo Gaming también eliminado' }],
      },
      {
        type: 'p',
        children: [
          {
            text: "Weibo Gaming, otro nombre destacado de la LPL, también fue eliminado antes de la gran final del lower bracket. Su caída, junto a la de BLG, refleja el altísimo nivel de competición en el qualifier de China este año, donde ningún equipo estaba a salvo independientemente de su historial en temporada regular.",
          },
        ],
      },
      {
