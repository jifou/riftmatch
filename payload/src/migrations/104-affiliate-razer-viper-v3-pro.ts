...
export const id = '104-affiliate-razer-viper-v3-pro'
...
const products = [
  {
    ...
    active: true,
    links: [
      { locale: 'fr', url: 'https://www.amazon.fr/dp/B0CW25XR5R' },
      { locale: 'en', url: 'https://www.amazon.co.uk/dp/B0CW25XR5R' },
      { locale: 'es', url: 'https://www.amazon.es/dp/B0CW25XR5R' },
    ],
    product: {
      name: 'Razer Viper V3 Pro',
      tagline: 'Souris esport sans-fil ultra-légère 54g — 8K polling, 35K DPI, 95h batterie',
