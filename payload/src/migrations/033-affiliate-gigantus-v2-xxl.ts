...
export const id = '033-affiliate-gigantus-v2-xxl'
export const description = 'Nouveau bloc affilié — Razer Gigantus V2 XXL (tapis de souris gaming)'
...
export const up: MigrationModule['up'] = async (payload) => {
  ...
  console.log('✅ Migration 033 terminée — Razer Gigantus V2 XXL')
}
