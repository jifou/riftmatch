...
const articles = [
  // FR
  {
    ...
    category: 'esports',
    newsType: 'riot',
    newsSubtype: 'other', // 'resultats' | 'mercato' | 'other' — choisis selon le contenu
    author: 'RiftMatch',
...
- `RIOT of the current year mercato today` → News Riot récents
...
- Y a eu des informations sur league of legends ou riot significatifs non encore couverts
...
- `payload/src/migrations/NNN-nom-descriptif.ts` pour news
